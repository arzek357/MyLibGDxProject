package com.mystargame.arzek.utils;
...
public class EnemyGenerator {
    ...
    public void generate (float delta, int frags){
        ...
        if (generateTimer>generateInterval){
            ...
            if (type<=0.5f)
            enemyShip.set(enemySmallRegions,enemySmallV,bulletRegion,ENEMY_SMALL_BULLET_HEIGHT,ENEMY_SMALL_BULLET_VY,ENEMY_SMALL_DAMAGE*level,ENEMY_SMALL_RELOAD_INTERVAL,ENEMY_SMALL_HP,ENEMY_SMALL_HEIGHT);
            else if (type<0.8f)
            enemyShip.set(enemyMediumRegions,enemyMediumV,bulletRegion,ENEMY_MEDIUM_BULLET_HEIGHT,ENEMY_MEDIUM_BULLET_VY,ENEMY_MEDIUM_DAMAGE*level,ENEMY_MEDIUM_RELOAD_INTERVAL,ENEMY_MEDIUM_HP,ENEMY_MEDIUM_HEIGHT);
            else
            enemyShip.set(enemyBigRegions,enemyBigV,bulletRegion,ENEMY_BIG_BULLET_HEIGHT,ENEMY_BIG_BULLET_VY,ENEMY_BIG_DAMAGE*level,ENEMY_BIG_RELOAD_INTERVAL,ENEMY_BIG_HP,ENEMY_BIG_HEIGHT);
